...
server <- function(input, output, session) {
        ...
        output$prediction1 <- renderText({
                ...
                x <- if_else(gregexpr("\\.", wordIn)[[1]][1]==nchar(wordIn) |
                                     gregexpr("\\?", wordIn)[[1]][1]==nchar(wordIn) | 
                                     wordIn=="", "I",
        ...
        output$prediction2 <- renderText({
                ...
                y <- if_else(gregexpr("\\.", wordIn)[[1]][1]==nchar(wordIn) |
                                     gregexpr("\\?", wordIn)[[1]][1]==nchar(wordIn) | 
                                     wordIn=="", "In",
        ...
        output$prediction3 <- renderText({
                ...
                z <- if_else(gregexpr("\\.", wordIn)[[1]][1]==nchar(wordIn) |
                                     gregexpr("\\?", wordIn)[[1]][1]==nchar(wordIn) | 
                                     wordIn=="", "The",
